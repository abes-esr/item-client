<template>
  <v-container fluid>
  <v-chip v-if="!archiveFalseActiveTrue" style="margin-right: 10px" @click="switchArchiveActiveDisplay(!archiveFalseActiveTrue)">Calculs de taux de recouvrement</v-chip>
  <v-chip v-if="archiveFalseActiveTrue" variant="plain" style="margin-right: 10px" @click="switchArchiveActiveDisplay(!archiveFalseActiveTrue)">Calculs de taux de recouvrement</v-chip>
  <v-chip v-if="archiveFalseActiveTrue" @click="switchArchiveActiveDisplay(!archiveFalseActiveTrue)">Calculs de taux de recouvrement archivés</v-chip>
  <v-chip v-if="!archiveFalseActiveTrue" variant="plain" @click="switchArchiveActiveDisplay(!archiveFalseActiveTrue)">Calculs de taux de recouvrement archivés</v-chip>
    <v-chip variant="text">
      <v-tooltip activator="parent" location="bottom">
        <template v-slot:activator="{ props }">
          <label>
            <input type="checkbox" v-model="extendedAllILN" style="margin-right: 5px" @change="loadItems('RECOUV', archiveFalseActiveTrue)">

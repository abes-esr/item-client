    ...
    <v-layout align-center justify-center>
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            <p>
              L'ABES s'engage à ce que la collecte et le traitement de vos données, effectués à partir du site
              <span
                style="font-weight: blod; color: red;"
              >Nom application (URL)</span>, soient conformes au Règlement Général européen sur la Protection des Données (RGPD).
            </p>
            <h2 class="display-1">1. Gestion des données personnelles</h2>
            <p
              style="font-weight: blod; color: red;"
            >Si pas des données personnelles ajouter la phrase :</p>
            ...
            <p>
              ...
              <span
                style="font-weight: blod; color: red;"
              >Ajouter numéro de déclaration ou mettre « Inscription par le DPO au registre de traitement »</span>
            </p>
            <p>
            ...
            </ul>Le ou les destinataires des données sont :
            <ul>
              <li style="font-weight: blod; color: red;">Destinataires des données</li>
              <li style="font-weight: blod; color: red;">Destinataires des données</li>
            </ul>
            <p>
              Conformément au Règlement Général européen sur la Protection des Données (RGPD), vous disposez d’un droit d’accès, de rectification et de
            ...
            <ul>
              ...
              <li style="font-weight: blod; color: red;">
                ...
                theses.fr:https://stp.abes.fr/node/3?origine=thesesFr
              </li>
              <li>Par courrier signé accompagné de la copie d’un titre d’identité à l'adresse suivante :
                <p>Agence Bibliographique de l'Enseignement Supérieur (ABES)
                  <br>A l'attention du DPO
            ...
            <p
              style="font-weight: blod; color: red;"
            >Selon l'application, enlever ou remplir cette partie</p>
            ...
            <p>
              ...
              <span
                style="font-weight: blod; color: red;"
              >Nom application (URL)</span>ne peut donc en aucun cas remonter par ce biais à une personne physique.
            </p>
            <p>
            ...
            <p>
              L'application
              <span style="font-weight: blod; color: red;">Nom application (URL)</span>s’appuie sur certains services proposés par des sites tiers. Il s’agit notamment :
            </p>
            <ul>
            ...
            <p>
              Ces fonctionnalités utilisent des cookies tiers directement déposés par ces services. Lors de votre première visite sur
              <span
                style="font-weight: blod; color: red;"
              >Nom application (URL)</span>, un bandeau vous informe de la présence de ces cookies et vous invite à indiquer votre choix.
            </p>
          </v-card-text>
        </v-card>
      </v-flex>

    ...
    <v-row align="center" justify="center">
      <v-col cols="12">
        <v-card>
          ...
          <v-card-text>
            <p>
              L'ABES s'engage à ce que la collecte et le traitement de vos données soient conformes au Règlement Général européen sur la Protection des Données (RGPD).
            </p>

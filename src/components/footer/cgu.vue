      ...
      <v-flex xs12>
        <v-card>
          ...
          <v-card-text>
            ...
            <p>
              Il pourra également supprimer toute information pouvant en perturber le fonctionnement ou entrant en contravention avec les lois nationales ou internationales, ou avec les règles de la Nétiquette (
              <a
                href="https://fr.wikipedia.org/wiki/N%C3%A9tiquette"
              >Nétiquette</a>).
            </p>
            <p>

      ...
      <v-flex xs12>
        <v-card>
          <v-card-title primary-title>
            <div>
              <h1 class="display-3">Conditions Générales d’Utilisation</h1>
            </div>
          </v-card-title>
          <v-card-text>
            <h2 class="display-1">1. Acceptation des conditions d’utilisation</h2>
            <p>L'accès et l'utilisation du site sont soumis à l'acceptation et au respect des présentes Conditions Générales d'Utilisation (CGU).</p>
            ...
            <h2 class="display-1">2. Gestion du site, accès et navigation</h2>
            <p>L'éditeur met en œuvre les solutions techniques à sa disposition pour permettre l'accès au site 24 heures sur 24, 7 jours sur 7. Il pourra néanmoins à tout moment suspendre, limiter une catégorie déterminée d'internaute ou interrompre l'accès au site ou à certaines pages de celui-ci afin de procéder à des mises à jour, des modifications de son contenu ou toute autre action jugée nécessaire au bon fonctionnement du site.</p>
            <p>Il pourra également supprimer toute information pouvant en perturber le fonctionnement ou entrant en contravention avec les lois nationales ou internationales, ou avec les règles de la Nétiquette (<a href="https://fr.wikipedia.org/wiki/N%C3%A9tiquette">Nétiquette</a>).</p>
            <p>La connexion et la navigation sur le site <span style="font-weight: blod; color: red;">Nom application (URL)</span> valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accès et les terminaux utilisés.</p>
            ...
            <p>Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels <span style="font-weight: blod; color: red;">Nom application (URL)</span> n'exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisées par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.</p>
            ...
            <p>Enfin, <span style="font-weight: blod; color: red;">Nom application (URL)</span> se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l'estime non conforme à sa politique éditoriale.</p>

<template>
  ...
  <v-stepper :value="current" :alt-labels=true>
    <v-stepper-header>
      ...
      <v-stepper-step v-if="this.numDemande !== undefined" step="1" :complete="current > 1">Sélection RCR<small>Demande n°<strong>{{this.numDemande}}</strong></small></v-stepper-step>
      <v-divider></v-divider>
